...
### Необходимо исправить перед имплементацией (КРИТИЧЕСКИЕ) - ✅ ВСЕ РЕШЕНЫ

1. ✅ **I1**: Обновлены требования аутентификации spec.md (FR-043, FR-044, User Story 7, Key Entities) для ссылки на @supabase/ssr вместо Passport.js
2. ✅ **I2**: Обновлён spec.md FR-048 с "MUI v5.x" на "MUI v6.x или последняя стабильная версия с ColorScheme API"
3. ✅ **I3**: Добавлены новые FR-073, FR-074, FR-075 для требований Turborepo, tsdown и скриптов сборки

### Рекомендуемые улучшения (ВЫСОКИЕ) - ✅ РЕШЕНЫ

4. ✅ **C1**: Добавлен FR-074 для требования двойной сборки tsdown
5. ✅ **C2**: Изменён FR-072 с "MAY" на "MUST" для pre-commit hooks (Husky)
6. ⬜ **C3**: Создать матрицу трассируемости требований (опционально, отложено)
7. ⬜ **C4**: Добавить примечание к FR-037-042 о выборе ORM (опционально)

### Опциональные улучшения (СРЕДНИЕ) - ✅ РЕШЕНЫ

8. ✅ **A1**: Очищены маркеры "NEEDS CLARIFICATION" в plan.md - заменены на ссылки "RESOLVED"
9. ⬜ **D1, D2**: Рассмотреть объединение избыточных требований (опционально, низкий приоритет)
10. ⬜ **T1**: Исправлен дрейф терминологии в Key Entities (выполнено в I1)
11. ✅ **T2**: Исправлен дрейф терминологии в tasks.md T082 (@supabase/ssr)
12. ✅ **U1**: Указан Vitest в FR-053
...
**Статус**: ✅ Все КРИТИЧЕСКИЕ проблемы РЕШЕНЫ — spec.md, plan.md, tasks.md обновлены и согласованы с конституцией
